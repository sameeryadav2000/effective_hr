  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-gray-100 sticky top-0 z-50 bg-white">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="sm:hidden border-t border-gray-100 px-4 py-4 space-y-3">
            <button className="block w-full text-left px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900">
              Sign In
            </button>
            <button className="block w-full px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700">
              Start Free Trial
            </button>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-6">
              Stop managing approvals on WhatsApp
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 mb-8">
              Centralized approval workflows with audit trails. Replace WhatsApp, Viber, and Excel spreadsheets with a system built for business.
            </p>
